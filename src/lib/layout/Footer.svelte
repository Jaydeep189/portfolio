	...
	<div class="px-4 py-16 sm:px-6 lg:px-8">
		<div class=" mx-auto max-w-5xl">
			<div class="flex justify-center">
				<h1
					class=" font-carveat text-3xl lg:text-5xl hover:text-teal-700 transition-all duration-300"
				>
					Jaydeep Sharma
				</h1>
			</div>
		...
		<div class="mt-6">
			<p class="text-gray-700 text-sm text-center">
				&copy; {d} Jaydeep Sharma.
				<a
					class="text-teal-700 hover:text-purple-800"
					href="https://github.com/Jaydeep189/portfolio"
